...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn mt-0">
            <a href="{{ route('product') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to
                Product</a>
        </div>
    </div>
                    ...
                    <h2 class="accordion-header">
                        <div class="accordion-button collapsed bg-primary">
                            <div class="d-flex align-items-center justify-content-between flex-fill">
                                <h5 class="d-flex align-items-center text-light"><span>Add Product</span></h5>
                            </div>
                        </div>
                    </h2>
                    @if ($errors->any())
    ...
    <script>
        $(document).ready(function() {
            $('#category_id').on('change', function() {
                ...
                if (category_id) {
                    $.ajax({
                        url: "{{ route('getSubcategories') }}", // Laravel route
                        type: "GET",
                        data: {
